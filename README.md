...
( **This reason of enough is described in 3 below ,** as e.g. "difference of each cocos2d-x files". )
...
by create-android-project.sh.</b> Incidentally, I think no need particularly for descriptions about
&nbsp; modifing <b>"NDK_ROOT_LOCAL" and"ANDROID_SDK_ROOT_LOCAL"</b> at the beginning of
this "create-android-project.sh" file because many descriptions already exist in various other places. i.e. 

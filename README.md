...
However, the contents in each Directories are almost the same except that
...
to the "Resource(s) <b>Dir</b>(ectry) in <b>C</b>"( =Android.mk in <b>C</b>lasses(in <b>H</b>lloWorld)<b>Dir</b>(ectry) )

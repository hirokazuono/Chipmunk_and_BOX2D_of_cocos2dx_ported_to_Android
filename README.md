...
&nbsp; about modifing <b>"NDK_ROOT_LOCAL" and"ANDROID_SDK_ROOT_LOCAL"</b> at the beginning
of this "create-android-project.sh" file because many descriptions already exist in various other places.
&nbsp; i.e. 

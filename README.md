...
&nbsp; within each downloaded dir(fld,of 11,12,&13beta from cocos2d-x.org).in addition, their xCode files can be changed to other xCode files by "-uf" above,  any time soon & freely. )

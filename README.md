...
**Also the "chg&copy list"**( of the changed files from the original files) **downloads in "this page"**,  
and **many changes of the files have been added annotation**(e.g."# ~ 1205xx xx:xx chg ~ ) **.** moreover,  
the changes has been kept to a minimum changes as can.&nbsp;&nbsp; If you use them, **apps can be created soon** .